                        ...
                        <a href="#" className="hover:text-white transition-colors duration-300">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1_1675)">
                                    <path d="M5.29333 15.2443C5.29333 16.6319 4.15978 17.7655 2.77215 17.7655C1.38453 17.7655 0.250977 16.6319 0.250977 15.2443C0.250977 13.8567 1.38453 12.7231 2.77215 12.7231H5.29333V15.2443Z" fill="white" fill-opacity="0.4" />
                                    <path d="M6.56348 15.2443C6.56348 13.8567 7.69703 12.7231 9.08466 12.7231C10.4722 12.7231 11.6058 13.8567 11.6058 15.2443V21.557C11.6058 22.9446 10.4722 24.0782 9.08466 24.0782C7.69703 24.0782 6.56348 22.9446 6.56348 21.557V15.2443Z" fill="white" fill-opacity="0.4" />
                                    <path d="M9.08466 5.12047C7.69703 5.12047 6.56348 3.98692 6.56348 2.59929C6.56348 1.21167 7.69703 0.078125 9.08466 0.078125C10.4723 0.078125 11.6059 1.21167 11.6059 2.59929V5.12047H9.08466Z" fill="white" fill-opacity="0.4" />
                                    <path d="M9.08486 6.39062C10.4725 6.39062 11.606 7.52417 11.606 8.91179C11.606 10.2994 10.4725 11.4329 9.08486 11.4329H2.77215C1.38453 11.4329 0.250977 10.2994 0.250977 8.91179C0.250977 7.52417 1.38453 6.39062 2.77215 6.39062H9.08486Z" fill="white" fill-opacity="0.4" />
                                    <path d="M19.2085 8.91179C19.2085 7.52417 20.3421 6.39062 21.7297 6.39062C23.1173 6.39062 24.2509 7.52417 24.2509 8.91179C24.2509 10.2994 23.1173 11.4329 21.7297 11.4329H19.2085V8.91179Z" fill="white" fill-opacity="0.4" />
                                    <path d="M17.9383 8.91201C17.9383 10.2996 16.8048 11.4331 15.4171 11.4331C14.0295 11.4331 12.896 10.2996 12.896 8.91201V2.59929C12.896 1.21167 14.0295 0.078125 15.4171 0.078125C16.8048 0.078125 17.9383 1.21167 17.9383 2.59929V8.91201Z" fill="white" fill-opacity="0.4" />
                                    <path d="M15.4171 19.0356C16.8048 19.0356 17.9383 20.1692 17.9383 21.5568C17.9383 22.9444 16.8048 24.078 15.4171 24.078C14.0295 24.078 12.896 22.9444 12.896 21.5568V19.0356H15.4171Z" fill="white" fill-opacity="0.4" />
                                    <path d="M15.4171 17.7655C14.0295 17.7655 12.896 16.6319 12.896 15.2443C12.896 13.8567 14.0295 12.7231 15.4171 12.7231H21.7298C23.1175 12.7231 24.251 13.8567 24.251 15.2443C24.251 16.6319 23.1175 17.7655 21.7298 17.7655H15.4171Z" fill="white" fill-opacity="0.4" />
                                </g>
                                <defs>
                        ...
                        <a href="#" className="hover:text-white transition-colors duration-300">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1_1685)">
                                    <path d="M19.6426 1.07812H23.3052L15.3052 10.2829L24.751 22.7648H17.3293L11.5462 15.1986L4.89556 22.7648H1.2329L9.81122 12.9335L0.750977 1.07812H8.36544L13.6185 8.01789L19.6426 1.07812ZM18.3414 20.548H20.3655L7.257 3.15041H5.04014L18.3414 20.548Z" fill="white" fill-opacity="0.4" />
                                </g>
                                <defs>
