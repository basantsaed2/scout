            ...
            <div className="px-4 py-2 border-t border-gray-800">
                ...
                <div className="space-y-1">
                    {apps.map((app, index) => (
                        <div
                            key={index}
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer transition-colors ${app.active ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800'
                                }`}
