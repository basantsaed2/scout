...
const PricingPlans = () => {
    return (
        <div className="min-h-screen bg-gradient-to-r from-[#171c1b] via-[#0d0d0e] to-[#282330] text-white px-2 md:px-8 py-16">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 p-6">
                    {/* Hobby Plan */}
                    <div className="bg-gradient-to-b from-[#0d1312] via-[#0b1913] to-[#0d1312] rounded-xl p-6">
                        <div className="flex items-center mb-6">
                            <div className="rounded-full mr-3">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_1_1525)">
                        ...
                        <button className="w-full bg-transparent border border-gray-600 text-white py-3 rounded-2xl font-medium hover:bg-gray-800 transition-colors mb-8">
                            Sign Up
                        </button>
                    ...
                    {/* Pro Plan */}
                    <div className="bg-gradient-to-b from-[#2e2833] via-[#2e2735] to-[#262229] rounded-xl p-6 relative shadow-lg shadow-purple-500/20">
                        <div className="absolute top-[-10px] left-1/2 transform -translate-x-1/2">
                            <div className="bg-gradient-to-b from-[#2e2833] via-[#2c253c] to-[#262229] text-white px-4 py-1.5 rounded-full text-xs font-medium uppercase tracking-wide">
                                MOST POPULAR
                            </div>
                        </div>
                    ...
                    {/* Enterprise Plan */}
                    <div className="bg-gradient-to-b from-[#151825] via-[#1b1922] to-[#18161a] rounded-xl p-6">
                        <div className="flex items-center mb-6">
                            <div className="rounded-full mr-3">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className=" text-white px-2 md:p-8">
                    <div className="w-full">
                        <div className="bg-[#1b1b1b] rounded-3xl p-8 border border-gray-700 md:flex items-center justify-between">
                            {/* Left section: Text and list */}
                            <div className="md:w-3/5 md:pr-12 mb-8 md:mb-0">
                                <h3 className="text-3xl mb-4">Dedicated Support</h3>
                                ...
                                <p className="text-gray-400 mb-4 uppercase">
                                    What&apos;s included
                                </p>
                            ...
                            <div className="bg-gradient-to-b from-[#2e2833] via-[#2c253c] to-[#262229] md:w-2/5 flex flex-col items-center p-8 rounded-2xl border border-gray-700 relative">
                                <div className="flex items-center px-4 py-2 gap-2 rounded-2xl shadow-2xl mb-4 bg-gradient-to-b from-[#2e2833] via-[#2c253c] to-[#262229]">
                                    {/* Plus Icon */}
                                    <div className=" bg-[#896ae4] w-5 h-5 flex items-center justify-center rounded-full">
                                        <span className="text-white text-xl font-bold">+</span>
                                    </div>
                                    <p className="text-white uppercase text-sm">Add on</p>
                                </div>
                                <h4 className="text-5xl font-semibold">$750</h4>
                                <p className="text-white mb-6">monthly</p>
                                <button className="text-[#000] bg-white font-semibold py-3 px-6 rounded-full w-full hover:bg-gray-600 transition-colors">
                                    Request Access
                                </button>
